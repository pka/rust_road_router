...
impl Server {
    ...
    pub fn distance(&mut self, from: NodeId, to: NodeId) -> Option<Weight> {
        ...
        // let forward_routine = self.forward_dijkstra.query_generator(Query { from, to });
        // let backward_routine = self.backward_dijkstra.query_generator(Query { from: to, to: from });
        ...
        //         match forward_routine.resume() {
        //             GeneratorState::Yielded(State { distance, node }) => {
        ...
        //                 }
        //             },
        //             GeneratorState::Complete(Some(distance)) => {
        //                 forward_done = true;
        //                 forward_progress = distance;
        ...
        //                 }
        //             },
        //             GeneratorState::Complete(None) => forward_done = true
        //         }
        //     } else {
        //         match backward_routine.resume() {
        //             GeneratorState::Yielded(State { distance, node }) => {
        ...
        //                 }
        //             },
        //             GeneratorState::Complete(None) => backward_done = true
        //         }
        //     }
        // }
